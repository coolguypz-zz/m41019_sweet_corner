...
export const itemDelete = id => async dispatch => {
   try {
      ...
      const res = await axios.delete(`/api/cart/items/${id}`, axiosConfig);
...
export const createCustomerAccount = value => async dispatch => {
   try {
      ...
      const res = await axios.post(`/auth/create-account`, payload, axiosConfig);
...
export const signIn = value => async dispatch => {
   try {
      ...
      const res = await axios.post(`/auth/sign-in`, payload, axiosConfig);
      dispatch({
...
export const getJWTsignIn = () => async dispatch => {
   try {
      ...
      const res = await axios.get(`/auth/sign-in`, axiosConfig);
      localStorage.removeItem("sc-cart-token");
...
export const CreateUserCheckout = () => async dispatch => {
   try {
      const axiosConfig = tokenCheck();
      await axios.post(`/api/orders`, {}, axiosConfig);
      const res= await axios.get(`/api/orders`, axiosConfig);
...
export const getUserCheckoutItem = (orderId) => async dispatch => {
  try {
    console.log("getUserCheckoutItem-orderId", orderId);
     ...
     const axiosConfig = tokenCheck();
     const res= await axios.get(`/api/orders/${orderId}`, axiosConfig);
